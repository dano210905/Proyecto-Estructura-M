...
public class ManejoMatriz 
{
    ...
    public Object BuscarMasAntiguo(Object mat[][], int maxf, int maxc)
    {
        ...
        int MasViejo=0,i,j;
        //recorrido por filas de la matriz para buscar el mas viejo
    ...
    public Object BuscarMasNuevo(Object mat[][], int maxf, int maxc)
    {
        ...
        Vehiculos objVehiculo=new Vehiculos();
        int MasNuevo=0,i,j;
        //recorrido por filas de la matriz para buscar el mas nuevo
        for(i=0;i<=maxf-1;i++)//ciclo filas
        {
            for(j=0;j<=maxc-1;j++)//ciclo columnas
            {
...
/*metodo que retorna el acumulado de modelos para el promedio*/
    public int AcumularModelos(Object mat[][], int maxf, int maxc)
    {
        //variable de retorno
        int acumModelo=0,i,j;
        //recorrido por filas
        for(i=0;i<=maxf-1;i++)//ciclo filas
        {
            for(j=0;j<=maxc-1;j++)//ciclo columnas
            {
                acumModelo=acumModelo+((Vehiculos)mat[i][j]).getModelo();
    ...
    public double PromediarModelo(Object mat[][], int maxf, int maxc)
    {
        return AcumularModelos(mat,maxf,maxc)/(maxf*maxc);
    }//fin promediar
    
    /*metodo que retorna el promedio de la primera fila*/
    public double PromediarPrimeraFila(Object mat[][],  int maxc)
    {
        //variable para ayudar al retorno
        int acumModelo=0,j;
        for(j=0;j<=maxc-1;j++)//ciclo columnas
            {
                acumModelo=acumModelo+((Vehiculos)mat[0][j]).getModelo();
